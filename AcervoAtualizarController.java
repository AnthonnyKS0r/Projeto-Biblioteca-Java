...
public class AcervoAtualizarController {
    ...
    public void botaolivro(ActionEvent event) throws IOException {
        ...
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getResource("acervo_atualizar_livros.fxml"));
        } catch (IOException e) {
    ...
    public void botaoFilme(ActionEvent event) throws IOException {
        // Adicionando log para verificar se o método é chamado
        System.out.println("Botão pressionado, tentando carregar acervo_atualizar_filmes.fxml");

        // Carrega o novo conteúdo que deve ser exibido
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getResource("acervo_atualizar_filmes.fxml"));
        } catch (IOException e) {
