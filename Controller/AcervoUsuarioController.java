...
public class AcervoUsuarioController {
    ...
    public void botaolivro(ActionEvent event) throws IOException {
        ...
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getResource("acervo_livros_usu.fxml"));
        } catch (IOException e) {
    ...
    public void botaoFilme(ActionEvent event) throws IOException {
        ...
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getResource("acervo_filmes_usu.fxml"));
        } catch (IOException e) {
            System.err.println("Erro ao carregar acervo_livros_usu.fxml: " + e.getMessage());
            e.printStackTrace();
            return;
